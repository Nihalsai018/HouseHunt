...
/**
 * Servlet implementation class GandhiChowkServlet
 */
public class GandhiChowkServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GandhiChowkServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/gandhichowk.jsp");
