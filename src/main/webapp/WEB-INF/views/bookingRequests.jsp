        ...
        <c:forEach var="booking" items="${requestScope.bookings}">
            <tr>
                <td>${booking.bookingId}</td>
                  <td>${booking.rentalId}</td>
                <td>
                    <!-- Additional row for displaying all tenant details in a list -->
                    <c:if test="${booking.tenantDetails ne null}">
                      
                        <ul>
                            <li><strong>Full Name:</strong> ${booking.tenantDetails.fullName}</li>
                            <li><strong>Phone:</strong> ${booking.tenantDetails.phone}</li>
                            <li><strong>Email:</strong> ${booking.tenantDetails.email}</li>
                            <li><strong>Address:</strong> ${booking.tenantDetails.address}</li>
                            <li><strong>Occupation:</strong> ${booking.tenantDetails.occupation}</li>
                ...
                <td>
                    <form action="${pageContext.request.contextPath}/update_status" method="post">
                        <input type="hidden" name="owner_id" value="${booking.ownerId}">
                        <input type="hidden" name="booking_id" value="${booking.bookingId}">
                        <select name="new_status">
                            <option value="Accepted" ${"Accepted".equals(booking.status) ? "selected" : ""}>Accept</option>
                            <option value="Rejected" ${"Rejected".equals(booking.status) ? "selected" : ""}>Reject</option>
                        </select>
