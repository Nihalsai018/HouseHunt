...
<body>
 ...
 <c:if test="${not empty booking}">
    ...
    <ul>
        <li><strong>Full Name:</strong> ${rentalData.fullName}</li>
        <li><strong>Phone:</strong> ${rentalData.phone}</li>
        <li><strong>Address:</strong> ${rentalData.address}</li>
        <li><strong>Area:</strong> ${rentalData.area}</li>
        <li><strong>Rent:</strong> ${rentalData.rent}</li>
        <li><strong>Size:</strong> ${rentalData.size}</li>
        <li><strong>Family Status:</strong> ${rentalData.familyStatus}</li>
    </ul>
    </td>
