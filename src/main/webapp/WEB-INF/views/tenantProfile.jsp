...
<body>
  ...
  <br><br><br>
    ...
    <%-- Retrieve tenant_id from the session --%>
    <%
        int tenantId = (int) session.getAttribute("tenantId");
        ...
        try {
            ...
            try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/househunthub", "root", "root")) {
                ...
                try (PreparedStatement statement = connection.prepareStatement(sql)) {
                    ...
                    <%
                            ...
                            out.println("No data found for the tenant.");
                        }
                    }
                }
            }
            ...
            e.printStackTrace();
            out.println("Error retrieving tenant details.");
        }
    %>
</div>
</div>
